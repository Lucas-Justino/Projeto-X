...
const Navbar = () => {
  return (
    <div className="flex flex-col w-1/4 lg:gap-[1px] 2xl:gap-[5px] 3xl:gap-[6px] p-2">
      ...
      <div className="flex">
        <button className="flex items-center gap-5 lg:h-[44px] 2xl:h-[52px] w-52 p-3 rounded-full hover:bg-[#181919]">
          <GoHome size={"30px"} color="white" />
          <span className="text-[#E7E9EA] text-xl">Página Inicial</span>
        </button>
      </div>
      <div className="flex">
        <button className="flex items-center gap-5 lg:h-[44px] 2xl:h-[52px] w-40 p-3 rounded-full hover:bg-[#181919]">
      ...
      <div className="flex">
        <button className="flex items-center gap-5 lg:h-[44px] 2xl:h-[52px] w-48 p-3 rounded-full hover:bg-[#181919]">
          <SlEnvolope size={"30px"} color="white" />
          <span className="text-[#E7E9EA] text-xl">Mensagens</span>
        </button>
      </div>
      <div className="flex">
        <button className="flex items-center gap-5 lg:h-[44px] 2xl:h-[52px] w-32 p-3 rounded-full hover:bg-[#181919]">
          <BsSlashSquare size={"30px"} color="white" />
          <span className="text-[#E7E9EA] text-xl">Grok</span>
        </button>
      </div>
      <div className="flex">
        <button className="flex items-center gap-5 lg:h-[44px] 2xl:h-[52px] w-36 p-3 rounded-full hover:bg-[#181919]">
      ...
      <div className="flex">
        <button className="flex gap-2 lg:h-[44px] 2xl:h-[52px] w-44 p-3 rounded-full hover:bg-[#181919]">
          <MyIcon width={"40px"} height={"40px"} />
      ...
      <div className="mt-6">
        <button className="flex bg-[#1D9BF0] items-center justify-center gap-5 lg:h-[44px] 2xl:h-[52px] 2xl:w-[234px] p-3 rounded-full hover:bg-[#1A8CD8] xl:w-[200px] lg:w-[150px]">
          <span className="text-[#E7E9EA] text-lg font-bold">Postar</span>
        </button>
      </div>
      <div className="rounded-full lg:w-[10px] xl:w-[250px] 2xl:h-[60px] 3xl:w-[290px] mt-24 lg:mt-24 flex hover:bg-[#181818] cursor-pointer gap-2 items-center justify-center">
        ...
        <div className="flex flex-col 3xl:w-[200px] 2xl:w-[150px] xl:w-[100px] lg:w-[50px]">
