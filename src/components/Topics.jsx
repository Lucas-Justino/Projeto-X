...
const Topics = () => {
  return (
    <div className="bg-black flex flex-col h-[52vh] border border-[#2F3336] rounded-xl xl:ml-2 3xl:m-2 cursor-pointer">
      ...
      <SuggestionTopic
        ...
        destaque={"Enem 2024"}
      />
      <div className="h-full flex items-center justify-start 3xl:ml-1 pl-3 hover:bg-[#080808] rounded-xl">
